...
IF OBJECT_ID('100m_national_open_results', 'U') IS NOT NULL
    DROP TABLE [100m_national_open_results];
...
CREATE TABLE bronze.[relays_local_2_results] (
	...
	[rank] INT								-- rank in each qualifying round or timed final for qualifying criteria
);
GO
...
-- ==============================
-- Bronze layer, competition_dates
-- ==============================

IF OBJECT_ID('competition_dates', 'U') IS NOT NULL
    DROP TABLE competition_dates;

CREATE TABLE bronze.[competition_dates] (
	...
	country NVARCHAR(50),					-- country of the competition
	continent NVARCHAR(50),					-- continent of the competition
...
-- ==============================
IF OBJECT_ID('national_records_202', 'U') IS NOT NULL
    DROP TABLE national_records_202;
